...
export const ADMIN_MODULES: AdminModuleDef[] = [
  ...
  { id: 'menus', href: '/admin/menus', icon: Menu, labelKey: 'superAdmin.nav.menus', groupKey: 'superAdmin.groups.content', status: 'planned', permission: 'admin.menus' },
  { id: 'banners', href: '/admin/banners', icon: Image, labelKey: 'superAdmin.nav.banners', groupKey: 'superAdmin.groups.content', status: 'beta', permission: 'admin.banners' },
  { id: 'campaigns', href: '/admin/campaigns', icon: Megaphone, labelKey: 'superAdmin.nav.campaigns', groupKey: 'superAdmin.groups.content', status: 'beta', permission: 'admin.campaigns' },
  { id: 'ai', href: '/admin/ai', icon: Bot, labelKey: 'superAdmin.nav.ai', groupKey: 'superAdmin.groups.content', status: 'beta', permission: 'admin.ai' },
  ...
  { id: 'notifications', href: '/admin/notifications', icon: Bell, labelKey: 'superAdmin.nav.notifications', groupKey: 'superAdmin.groups.communications', status: 'planned', permission: 'admin.notifications' },
  { id: 'support', href: '/admin/support', icon: Headphones, labelKey: 'superAdmin.nav.support', groupKey: 'superAdmin.groups.communications', status: 'planned', permission: 'admin.support' },
  ...
  { id: 'backup', href: '/admin/backup', icon: Database, labelKey: 'superAdmin.nav.backup', groupKey: 'superAdmin.groups.platform', status: 'planned', permission: 'admin.backup' },
];
