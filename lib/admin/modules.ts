...
export const ADMIN_MODULES: AdminModuleDef[] = [
  ...
  { id: 'studio-etsy', href: '/admin/studio/etsy', icon: Package, labelKey: 'superAdmin.nav.studioEtsy', groupKey: 'superAdmin.groups.communications', status: 'live', permission: 'admin.studio' },
