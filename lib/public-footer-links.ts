  ...
  return [
    {
      ...
      links: [
        ...
        { href: '/integrations/hubspot', label: t('nav.hubspot') },
        { href: '/integrations/salesforce', label: t('nav.salesforce') },
    ...
    },
    {
      ...
      links: [
        ...
        { href: '/dpa', label: t('nav.dpa') },
        { href: '/sub-processors', label: t('nav.subprocessors') },
      ],
    },
    {
