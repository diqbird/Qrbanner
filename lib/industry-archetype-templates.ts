...
export const ARCHETYPE_INDUSTRY_TEMPLATES: IndustryTemplate[] = [
  ...
  },
  {
    ...
    description: 'Supermarkets, grocers, markets and delis linking shelf signs to the weekly flyer and loyalty program.',
    useCases: ['Weekly flyer stand', 'Aisle shelf talker', 'Loyalty signup poster', 'Checkout counter'],
    suggestedQrName: 'Weekly Circular — Main Store',
    qrData: { url: 'https://yourstore.com/weekly', _storeName: '', _loyaltyUrl: '', _weekOf: '', _openHours: '' },
    style: {
      fgColor: '#15803d',
      bgColor: '#f0fdf4',
      dotStyle: 'rounded',
    ...
    sections: [
      {
        ...
        description: 'Your live weekly flyer, circular or deals page — update it without reprinting shelf signs.',
        fields: [
          { key: 'url', label: 'Weekly deals URL', placeholder: 'https://yourstore.com/weekly', required: true, type: 'url' },
        ],
      },
      {
        id: 'store',
        title: 'Store details',
        description: 'Shown on the landing page for shoppers.',
        fields: [
          { key: '_storeName', label: 'Store name', placeholder: 'FreshMart Kadıköy', type: 'text' },
          { key: '_loyaltyUrl', label: 'Loyalty signup URL', placeholder: 'https://yourstore.com/loyalty', type: 'url' },
          { key: '_weekOf', label: 'Valid dates', placeholder: 'Valid 8–14 July', type: 'text' },
          { key: '_openHours', label: 'Opening hours', placeholder: 'Daily 08:00–22:00', type: 'text' },
        ],
      },
    ],
    tips: [
      'Swap the weekly flyer link every Monday — same printed shelf QR.',
      'Add a loyalty signup URL to grow your list from the aisle.',
      'Use a separate QR per store location for footfall analytics.',
    ],
    landingPage: { enabled: true, template: 'minimal', title: 'This Week\'s Deals', accentColor: '#15803d', ctaLabel: 'View Offers' },
  },
  {
    ...
    qrData: { url: 'https://yourvenue.com/tickets', _venueName: '', _event: '', _showtimes: '', _merchUrl: '' },
    style: {
      fgColor: '#7c2d12',
      bgColor: '#fff7ed',
      dotStyle: 'rounded',
    ...
    sections: [
      {
        ...
        fields: [
          { key: 'url', label: 'Tickets URL', placeholder: 'https://yourvenue.com/tickets', required: true, type: 'url' },
        ],
      },
      {
        id: 'venue',
        title: 'Venue & show details',
        description: 'Shown on the landing page before redirect.',
        fields: [
          { key: '_venueName', label: 'Venue name', placeholder: 'The Grand Theatre', type: 'text' },
          { key: '_event', label: 'Show / release', placeholder: 'Summer Jazz Nights', type: 'text' },
          { key: '_showtimes', label: 'Showtimes', placeholder: 'Fri–Sun · 20:00', type: 'text' },
          { key: '_merchUrl', label: 'Merch / info URL', placeholder: 'https://yourvenue.com/merch', type: 'url' },
        ],
      },
    ],
    tips: [
      'Swap show URLs between events — same printed poster QR.',
      'Schedule the QR to go live on announcement day.',
      'Add a merch link to capture extra revenue from the same scan.',
    ],
