...
export const SITE_SEARCH_INDEX: SiteSearchItem[] = [
  ...
  {
    id: 'affiliates',
    titleKey: 'siteSearch.affiliates',
    href: '/affiliates',
    groupKey: 'siteSearch.groupPages',
    keywords: ['affiliate', 'partner', 'commission'],
  },
  {
    id: 'roi-calculator',
    titleKey: 'siteSearch.roiCalculator',
    href: '/roi-calculator',
    groupKey: 'siteSearch.groupPages',
    keywords: ['roi', 'calculator', 'savings'],
  },
  {
    id: 'demo',
    titleKey: 'siteSearch.demo',
    href: '/demo',
    groupKey: 'siteSearch.groupPages',
    keywords: ['demo', 'tour', 'video'],
  },
  {
    id: 'customers',
    titleKey: 'siteSearch.customers',
    href: '/customers',
    groupKey: 'siteSearch.groupPages',
    keywords: ['customers', 'logos', 'social proof'],
  },
  {
    id: 'reviews',
    titleKey: 'siteSearch.reviews',
    href: '/reviews',
    groupKey: 'siteSearch.groupPages',
    keywords: ['reviews', 'g2', 'capterra', 'testimonials'],
  },
  {
    id: 'zapier',
    titleKey: 'siteSearch.zapier',
    href: '/integrations/zapier',
    groupKey: 'siteSearch.groupPages',
    keywords: ['zapier', 'zap', 'webhook', 'automation'],
  },
