#!/usr/bin/env python3
"""Deploy Growth Pack v12–v15: content, i18n index pages, integrations teaser."""
import os
import sys
import paramiko
...
FILES = [
    ...
    "components/landing/case-studies-teaser.tsx",
...
_, o, _ = c.exec_command(
    f"cd {REMOTE} && yarn build > /tmp/qrb-growth15.log 2>&1; echo EXIT:$?; tail -12 /tmp/qrb-growth15.log",
    timeout=600,
)
out = o.read().decode("utf-8", errors="replace")
with open(os.path.join(LOCAL, "scripts", "_deploy_growth15.txt"), "w", encoding="utf-8") as f:
    f.write(out)
