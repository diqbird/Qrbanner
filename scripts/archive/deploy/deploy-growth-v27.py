#!/usr/bin/env python3
"""Deploy Growth Pack v27: privacy/cookies/faq/pricing metadata i18n, +2 content, +2 logos."""
import glob
import os
import sys
import paramiko
...
FILES = [
    ...
    "lib/blog/posts/tourist-attraction-qr.ts",
    "lib/blog/posts/florist-gift-shop-qr.ts",
    "public/logos/trade-show.svg",
    "public/logos/cafe.svg",
    "app/sitemap.ts",
]
...
_, o, _ = c.exec_command(
    f"cd {REMOTE} && yarn build > /tmp/qrb-growth27.log 2>&1; echo EXIT:$?; tail -40 /tmp/qrb-growth27.log",
    timeout=600,
)
out = o.read().decode("utf-8", errors="replace")
with open(os.path.join(LOCAL, "scripts", "_deploy_growth27.txt"), "w", encoding="utf-8") as f:
    f.write(out)
