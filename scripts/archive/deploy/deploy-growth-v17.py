#!/usr/bin/env python3
"""Deploy Growth Pack v12–v17: about/contact i18n, brewery/insurance, content."""
import os
import sys
import paramiko
...
_, o, _ = c.exec_command(
    f"cd {REMOTE} && yarn build > /tmp/qrb-growth17.log 2>&1; echo EXIT:$?; tail -40 /tmp/qrb-growth17.log",
    timeout=600,
)
out = o.read().decode("utf-8", errors="replace")
with open(os.path.join(LOCAL, "scripts", "_deploy_growth17.txt"), "w", encoding="utf-8") as f:
    f.write(out)
