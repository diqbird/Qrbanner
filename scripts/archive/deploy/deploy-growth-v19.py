#!/usr/bin/env python3
"""Deploy Growth Pack v19: blog/pricing/faq/vs i18n, ROI locale, +2 content each."""
import glob
import os
import sys
import paramiko
...
FILES = [
    ...
    "lib/blog/posts/dental-practice-qr-codes.ts",
    "lib/blog/posts/veterinary-clinic-qr.ts",
    "app/sitemap.ts",
]
...
_, o, _ = c.exec_command(
    f"cd {REMOTE} && yarn build > /tmp/qrb-growth19.log 2>&1; echo EXIT:$?; tail -40 /tmp/qrb-growth19.log",
    timeout=600,
)
out = o.read().decode("utf-8", errors="replace")
with open(os.path.join(LOCAL, "scripts", "_deploy_growth19.txt"), "w", encoding="utf-8") as f:
    f.write(out)
