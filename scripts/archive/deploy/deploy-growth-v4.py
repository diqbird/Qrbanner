#!/usr/bin/env python3
"""Deploy Growth Pack v4: enterprise, sales form, logos, blog."""
import os
import sys
import paramiko
...
_, o, _ = c.exec_command(
    f"cd {REMOTE} && yarn build > /tmp/qrb-growth4.log 2>&1; echo EXIT:$?; tail -12 /tmp/qrb-growth4.log",
    timeout=600,
)
out = o.read().decode("utf-8", errors="replace")
with open(os.path.join(LOCAL, "scripts", "_deploy_growth4.txt"), "w", encoding="utf-8") as f:
    f.write(out)
