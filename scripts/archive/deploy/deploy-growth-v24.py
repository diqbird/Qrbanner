#!/usr/bin/env python3
"""Deploy Growth Pack v24: privacy i18n, +2 content each."""
import glob
import os
import sys
import paramiko
...
FILES = [
    ...
    "lib/blog/posts/farmers-market-qr.ts",
    "lib/blog/posts/wine-tasting-room-qr.ts",
    "app/sitemap.ts",
]
...
_, o, _ = c.exec_command(
    f"cd {REMOTE} && yarn build > /tmp/qrb-growth24.log 2>&1; echo EXIT:$?; tail -40 /tmp/qrb-growth24.log",
    timeout=600,
)
out = o.read().decode("utf-8", errors="replace")
with open(os.path.join(LOCAL, "scripts", "_deploy_growth24.txt"), "w", encoding="utf-8") as f:
    f.write(out)
