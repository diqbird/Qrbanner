#!/usr/bin/env python3
"""Deploy dashboard settings i18n + templates + NFC."""
import os
import sys
import paramiko
...
_, o, _ = c.exec_command(
    f"cd {REMOTE} && yarn build > /tmp/qrb-settings-i18n.log 2>&1; echo EXIT:$?; tail -25 /tmp/qrb-settings-i18n.log",
    timeout=600,
)
out = o.read().decode("utf-8", errors="replace")
with open(os.path.join(LOCAL, "scripts", "_deploy_settings_i18n.txt"), "w", encoding="utf-8") as f:
    f.write(out)
