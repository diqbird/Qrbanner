#!/usr/bin/env python3
"""Deploy Growth Pack v9: create tips, case studies, G2 guide, logos, blog."""
import os
import sys
import paramiko
...
FILES = [
    ...
    "components/qr/create-step-tip.tsx",
...
_, o, _ = c.exec_command(
    f"cd {REMOTE} && yarn build > /tmp/qrb-growth9.log 2>&1; echo EXIT:$?; tail -12 /tmp/qrb-growth9.log",
    timeout=600,
)
out = o.read().decode("utf-8", errors="replace")
with open(os.path.join(LOCAL, "scripts", "_deploy_growth9.txt"), "w", encoding="utf-8") as f:
    f.write(out)
