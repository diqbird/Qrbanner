...
FILES = [
    ...
    "lib/landing-ai.ts",
    "lib/landing-llm.ts",
    "app/api/landing-page/generate-copy/route.ts",
    ...
    "components/qr/gps-heatmap-globe.tsx",
    "components/qr/gps-heatmap-globe-inner.tsx",
    ...
    "components/admin/admin-blog-editor.tsx",
    "components/seo/seo-preview-card.tsx",
    "components/auth/login-form.tsx",
    "components/admin/media-picker-dialog.tsx",
    "components/dashboard/media-library-card.tsx",
    "app/api/admin/blog/[id]/route.ts",
    "app/api/media/[id]/route.ts",
    "components/public/blog-article-body.tsx",
    "lib/blog/types.ts",
    "lib/blog/posts-service.ts",
    "lib/blog/posts/totp-two-factor-guide.ts",
    "lib/blog/posts/landing-cta-analytics-guide.ts",
    "lib/blog/posts/ai-landing-copy-guide.ts",
    "components/public/features-page-content.tsx",
    "app/api/admin/audit-log/route.ts",
    "lib/admin-audit.ts",
    "app/api/auth/sso-policy/route.ts",
    ...
    "components/seo/programmatic-internal-links.tsx",
    "lib/i18n/resolve-programmatic-copy.ts",
    "lib/i18n/use-case-copy-tr.ts",
    "lib/i18n/qr-type-copy-tr.ts",
