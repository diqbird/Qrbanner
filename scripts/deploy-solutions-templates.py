...
FILES = [
    ...
    "components/qr/landing-block-builder.tsx",
    "lib/landing-page.ts",
    ...
    "components/qr/qr-preview-skeleton.tsx",
    "components/qr/qr-edit-view.tsx",
    "app/(dashboard)/qr/[id]/page.tsx",
    "components/qr/qr-preview.tsx",
    ...
    "lib/analytics-roi.ts",
    "components/analytics/analytics-funnel-panel.tsx",
    "components/analytics/analytics-utm-charts.tsx",
    "components/analytics/analytics-roi-card.tsx",
    ...
    "lib/marketplace-sanitize.ts",
    "lib/marketplace-seller.ts",
    "lib/marketplace-connect.ts",
    "lib/secret-crypto.ts",
    "lib/workspace-enterprise.ts",
    "lib/tenant-email.ts",
    "lib/scim.ts",
    "app/api/workspace/enterprise/route.ts",
    "app/api/workspace/clients/route.ts",
    "app/api/workspace/clients/[id]/route.ts",
    ...
    "app/api/marketplace/seller/route.ts",
    "app/api/marketplace/purchase/route.ts",
    "app/api/marketplace/connect/onboard/route.ts",
    "components/dashboard/marketplace-seller-panel.tsx",
    "components/dashboard/plan-usage-card.tsx",
    "app/api/account/usage/route.ts",
    "components/templates/community-marketplace-section.tsx",
    "components/templates/marketplace-purchase-button.tsx",
    ...
    "app/api/automations/logs/route.ts",
    "components/dashboard/automation-builder.tsx",
    ...
    "components/public-footer.tsx",
    "lib/geo-seo-pages.ts",
    "app/(public)/geo/page.tsx",
    "app/(public)/geo/[city]/page.tsx",
    "app/(public)/geo/[city]/[sector]/page.tsx",
    "app/sitemap.ts",
    "middleware.ts",
    ...
    "components/landing/deferred-section.tsx",
    "lib/campaign-types.ts",
    "lib/campaign-fallback.ts",
    "lib/campaign-ai.ts",
    "lib/campaign-sanitize.ts",
    "lib/campaigns.ts",
    ...
    "app/(public)/qr/campaign/page.tsx",
    "components/dashboard/dashboard-content.tsx",
    ...
    "lib/file-magic.ts",
    "lib/site-search.ts",
    "hooks/use-qr-style-history.ts",
    "components/seo/locale-head-links.tsx",
    "components/search/site-search-dialog.tsx",
    "components/qr/style-history-toolbar.tsx",
    ...
    "components/onboarding/onboarding-success-card.tsx",
...
_, stdout_db, _ = c.exec_command(
    f"cd {REMOTE} && npx prisma generate && npx prisma db push --accept-data-loss --skip-generate 2>&1 | tail -10",
    timeout=180,
)
