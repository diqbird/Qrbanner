#!/usr/bin/env python3
"""Deploy Growth Pack v26: metadata i18n, +2 content, +2 logos."""
import glob
import os
import sys
import paramiko
...
FILES = [
    ...
    "lib/blog/posts/trade-show-booth-qr.ts",
    "lib/blog/posts/coffee-shop-loyalty-qr.ts",
    "public/logos/marina.svg",
    "public/logos/staffing.svg",
    "app/sitemap.ts",
]
...
_, o, _ = c.exec_command(
    f"cd {REMOTE} && yarn build > /tmp/qrb-growth26.log 2>&1; echo EXIT:$?; tail -40 /tmp/qrb-growth26.log",
    timeout=600,
)
out = o.read().decode("utf-8", errors="replace")
with open(os.path.join(LOCAL, "scripts", "_deploy_growth26.txt"), "w", encoding="utf-8") as f:
    f.write(out)
